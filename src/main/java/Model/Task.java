...
public class Task {
    ...
    public Task(String id, String prName, String title, String name, String startDate, String deadline,
                String finishDate, int expectedTime, int finishTime, int processed) {
        this.id = id;
        this.prName = prName;
        this.title = title;
        this.name = name;
